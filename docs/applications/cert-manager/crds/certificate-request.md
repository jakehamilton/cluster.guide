...
Cert-Manager uses [Custom Resource Definitions](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/)
to manage state and accept configuration. Create the following definitions in your cluster.

:::info
Create this file as `cert-manager/custom-resource-definitions/certificaterequests.cert-manager.io.yaml`
:::
